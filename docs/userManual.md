...
***
#### 3. Descripción del Sistema Móvil para Docentes
...
La pantalla de "Lista de Estudiantes Inscritos" es una interfaz diseñada para que los docentes puedan visualizar la lista de estudiantes inscritos en un curso específico. Esta pantalla les permite tener una visión general de los estudiantes que forman parte del curso.
##### 3.3.1. Pantalla 3
[![N|Solid](https://i.imgur.com/XdSntkr.png)](https://nodesource.com/products/nsolid)

##### 3.4. Descripción Pantalla 4
Al seleccionar un estudiante, se presentara la pantalla de "Registro de Asistencia del Estudiante Inscrito" que es una interfaz diseñada para que los docentes puedan tomar y registrar la asistencia de los estudiantes inscritos en un curso específico. Esta pantalla les permite realizar un seguimiento preciso de la asistencia de los estudiantes
##### 3.4.1. Pantalla 4
[![N|Solid](https://i.imgur.com/KRTHZAX.png)](https://nodesource.com/products/nsolid)

##### 3.5. Descripción Pantalla 5
La pantalla de "Registrar Asistencia Escaneando el Código QR" es una interfaz diseñada para que los docentes puedan registrar la asistencia de los estudiantes inscritos en un curso específico utilizando la tecnología de escaneo de códigos QR. Esta pantalla les permite agilizar el proceso de registro de asistencia al utilizar un código QR único asociado a cada estudiante. 
##### 3.5.1. Pantalla 5
[![N|Solid](https://i.imgur.com/Ojqi8wO.png)](https://nodesource.com/products/nsolid)

##### 3.6. Descripción Pantalla 6
La pantalla de "Asignar Calificación del Estudiante Inscrito" es una interfaz diseñada para que los docentes puedan asignar calificaciones a los estudiantes inscritos en un curso específico. Se selecciona el evento al que esta inscrito, selecciona el estudiante y se le asigna una calificación.
##### 3.6.1. Pantalla 6
[![N|Solid](https://i.imgur.com/wJlCXx1.png)](https://nodesource.com/products/nsolid)

##### 3.7. Descripción Pantalla 7
La pantalla de "Cambiar Contraseña" es una interfaz diseñada para permitir a los docentes modificar su contraseña actual y establecer una nueva contraseña. 
##### 3.7.1. Pantalla 7
[![N|Solid](https://i.imgur.com/7rAk1o4.png)](https://nodesource.com/products/nsolid)

##### 3.8. Descripción Pantalla 8
La pantalla de "Cerrar Sesión" es una interfaz diseñada para permitir a los docentes finalizar su sesión en la aplicación móvil. 
##### 3.8.1. Pantalla 8
[![N|Solid](https://i.imgur.com/Vv4B3QP.png)](https://nodesource.com/products/nsolid)

***
#### 4. Descripción del Sistema Móvil para Estudiantes
...
La pantalla de "Inicio de Sesión" de estudiantes es la primera interfaz que los estudiantes encontrarán al acceder a la aplicación. Su objetivo principal es permitir a los estudiantes iniciar sesión en sus cuentas para acceder a las funcionalidades y recursos disponibles para ellos. En esta pantalla deberan ingresar el Correo y la Contraseña, posteriormente presionar el botón de Iniciar Sesión.
##### 4.1.1. Pantalla 1
[![N|Solid](https://i.imgur.com/uGveAog.png)](https://nodesource.com/products/nsolid)
