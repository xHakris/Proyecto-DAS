...
import 'editar_detalles_eventos_model.dart';
export 'editar_detalles_eventos_model.dart';

class EditarDetallesEventosWidget extends StatefulWidget {
  const EditarDetallesEventosWidget({
    Key? key,
    this.eventoParameter,
  }) : super(key: key);

  final EventoRecord? eventoParameter;

  @override
  _EditarDetallesEventosWidgetState createState() =>
      _EditarDetallesEventosWidgetState();
}

class _EditarDetallesEventosWidgetState
    extends State<EditarDetallesEventosWidget> with TickerProviderStateMixin {
  late EditarDetallesEventosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarDetallesEventosModel());
