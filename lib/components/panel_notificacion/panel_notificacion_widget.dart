...
import '/components/empty_states/sin_notificaciones/sin_notificaciones_widget.dart';
...
import 'panel_notificacion_model.dart';
export 'panel_notificacion_model.dart';

class PanelNotificacionWidget extends StatefulWidget {
  const PanelNotificacionWidget({Key? key}) : super(key: key);

  @override
  _PanelNotificacionWidgetState createState() =>
      _PanelNotificacionWidgetState();
}

class _PanelNotificacionWidgetState extends State<PanelNotificacionWidget> {
  late PanelNotificacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PanelNotificacionModel());
