...
import '/components/u_i_components/create_note/create_note_widget.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 0.0),
                              child: AutoSizeText(
                                widget.taskRef!.description.maybeHandleOverflow(
                                  maxChars: 200,
                                  replacement: '…',
                                ),
                                maxLines: 3,
                      ...
                      Container(
                        ...
                        child: Builder(
                          builder: (context) {
                            final members = widget.taskRef!.members.toList();
                                ...
                                return Padding(
                                  ...
                                  child: FutureBuilder<UsersRecord>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final proPlanUsersRecord = snapshot.data!;
                                      return Container(
                                        width: 240.0,
                                        decoration: BoxDecoration(
                                          color: FlutterFlowTheme.of(context)
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    await widget.taskRef!.reference
                                        .update(createAllTasksRecordData(
                                      status: 'Complete',
                                      completed: true,
                                      completedAt: getCurrentTimestamp,
                                    ));

                                    await widget.taskRef!.projectRef!.update({
