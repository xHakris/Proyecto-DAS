...
import 'eventos_admin_model.dart';
export 'eventos_admin_model.dart';

class EventosAdminWidget extends StatefulWidget {
  const EventosAdminWidget({Key? key}) : super(key: key);

  @override
  _EventosAdminWidgetState createState() => _EventosAdminWidgetState();
}

class _EventosAdminWidgetState extends State<EventosAdminWidget>
    with TickerProviderStateMixin {
  late EventosAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventosAdminModel());
