...
import 'web_mi_equipo_model.dart';
export 'web_mi_equipo_model.dart';

class WebMiEquipoWidget extends StatefulWidget {
  const WebMiEquipoWidget({Key? key}) : super(key: key);

  @override
  _WebMiEquipoWidgetState createState() => _WebMiEquipoWidgetState();
}

class _WebMiEquipoWidgetState extends State<WebMiEquipoWidget> {
  late WebMiEquipoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebMiEquipoModel());
