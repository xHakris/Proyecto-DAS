...
class CambioContrasenaWidget extends StatefulWidget {
  const CambioContrasenaWidget({Key? key}) : super(key: key);

  @override
  _CambioContrasenaWidgetState createState() => _CambioContrasenaWidgetState();
}
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'fjhybvst' /* Le enviaremos un correo electr... */,
                    ),
