                      ...
                      Padding(
                        ...
                        child: StreamBuilder<List<EventoRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<EventoRecord> desktopViewEventoRecordList =
                                snapshot.data!;
                            if (desktopViewEventoRecordList.isEmpty) {
                              return Center(
                                child: Container(
                                  height: 600.0,
                                  child: SinEventosCreadosWidget(
                                    title: 'No Projects',
                                    bodyText:
                            ...
                            return Wrap(
                              ...
                              children: List.generate(
                                  desktopViewEventoRecordList.length,
                                  (desktopViewIndex) {
                                final desktopViewEventoRecord =
                                    desktopViewEventoRecordList[
                                        desktopViewIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 8.0, 12.0, 8.0),
                                                ...
                                                child: Padding(
                                                  padding:
                                                      MediaQuery.viewInsetsOf(
                                                          context),
                                                  child: EventoDetallesWidget(
                                                    eventoRef:
                                                        desktopViewEventoRecord,
                                                  ),
                                                ),
                                              );
                                            },
