...
import 'eventos_estudiante_model.dart';
export 'eventos_estudiante_model.dart';

class EventosEstudianteWidget extends StatefulWidget {
  const EventosEstudianteWidget({Key? key}) : super(key: key);

  @override
  _EventosEstudianteWidgetState createState() =>
      _EventosEstudianteWidgetState();
}

class _EventosEstudianteWidgetState extends State<EventosEstudianteWidget>
    with TickerProviderStateMixin {
  late EventosEstudianteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventosEstudianteModel());
