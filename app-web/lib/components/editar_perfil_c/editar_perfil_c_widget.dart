...
import 'editar_perfil_c_model.dart';
export 'editar_perfil_c_model.dart';

class EditarPerfilCWidget extends StatefulWidget {
  const EditarPerfilCWidget({Key? key}) : super(key: key);

  @override
  _EditarPerfilCWidgetState createState() => _EditarPerfilCWidgetState();
}

class _EditarPerfilCWidgetState extends State<EditarPerfilCWidget> {
  late EditarPerfilCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarPerfilCModel());
