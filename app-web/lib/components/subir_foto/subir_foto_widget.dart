...
import 'subir_foto_model.dart';
export 'subir_foto_model.dart';
...
class _SubirFotoWidgetState extends State<SubirFotoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubirFotoModel());
                        ...
                        children: [
                          Expanded(
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'xkv4rj30' /* Cargue una nueva foto a contin... */,
                                ),
